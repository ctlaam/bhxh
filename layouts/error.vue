<template>
  <div>
    ...
    <div class="btn-box d-flex align-items-center justify-content-center">
      <div class="btn" @click="$router.push('/')">Trang chủ</div>
      <div class="btn" @click="$router.push('/login')">Đăng nhập</div>
    </div>
  </div>
</template>
...
.btn-box .btn {
  background-image: url(data:image/png;base64,);
